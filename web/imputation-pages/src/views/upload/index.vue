<template>
  ...
  <div class="flex-lg-1 h-screen overflow-y-lg-auto " style="margin-top: 6rem">
    ...
    <main class="py-6 bg-surface-secondary">
      <div class="container">
        <!-- Title -->
        <h2 class="h2 ls-tight mb-4">Input Files (<b-link href="https://www.internationalgenome.org/wiki/Analysis/Variant%20Call%20Format/vcf-variant-call-format-version-41">VCF</b-link>)</h2>
        ...
        <div class="card">
          <div class="card-body pb-0">
            ...
            <div class="row" style="margin: 0.5rem 0rem;">
              ...
              <div class="col-xl-3 col-sm-6 input-group-sm input-group-inline">
                <input type="text" class="form-control" v-model.trim="chrom" ref="fileName" @blur="chrom" style="border: 1px solid #ced4da;"/>
              </div>
            </div>
                ...
                <tbody>
                  <tr v-for="file in files.fileList" :key="file.fileId">  
                    ...
                    <td>
                      ...
                      <b-button variant="danger" @click="deleteFile(file.fileId)" style="background-color: #f36!important;border-color: #f36!important;">submit</b-button>
                    </td>
                  </tr>
                </tbody>
              </table>
...
.row {
    ...
    margin-left: calc(var(--x-gutter-x)*-.5) !important;
    margin-right: calc(var(--x-gutter-x)*-.5) !important;
