...
<b-container class="bv-example-row">
  <b-navbar class="fixed-top" style="background: rgb(79, 93, 115) !important;" toggleable="lg" type="dark" variant="dark">
...
export default {
    ...
    mounted() {
      ...
      //为总线绑定函数
      this.$bus.$on('setLoginVal',this.setLoginVal)
    },
    beforeDestroy() {
      //销毁总线绑定的函数
      this.$bus.$off('setLoginVal')
    }
}
</script>
