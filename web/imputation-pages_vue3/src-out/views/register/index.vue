<template>
  <b-container class="bv-example-row page mt p-5" style="">
      ...
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkUserName"
          />
          <div class="invalid" v-show="invalidUsername.type">
            {{ invalidUsername.msg }}
          </div>
        </div>
      </b-col>
      ...
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkFirstName"
          />
          <div class="invalid" v-show="invalidFirstName.type">
            {{ invalidFirstName.msg }}
          </div>
        </div>
      </b-col>
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkLastName"
          />
          <div class="invalid" v-show="invalidLastName.type">
            {{ invalidLastName.msg }}
          </div>
        </div>
      </b-col>
      ...
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkmail"
          />
          <div class="invalid" v-show="invalidEmail.type">
            {{ invalidEmail.msg }}
          </div>
        </div>
      </b-col>
      ...
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkJobTitle"
          />
          <div class="invalid" v-show="invalidJobTitle.type">
            {{ invalidJobTitle.msg }}
          </div>
        </div>
      </b-col>
      ...
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkOrganisation"
          />
          <div class="invalid" v-show="invalidOrganisation.type">
            {{ invalidOrganisation.msg }}
          </div>
        </div>
      </b-col>
    </b-row>
      ...
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkCountry"
          />
          <div class="invalid" v-show="invalidCountry.type">
            {{ invalidCountry.msg }}
          </div>
        </div>
      </b-col>
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <input
            ...
            @blur="checkCity"
          />
          <div class="invalid" v-show="invalidCity.type">
            {{ invalidCity.msg }}
          </div>
        </div>
      </b-col>
    ...
    <b-row class="my-1">
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <div class="invalid" v-show="invalidPassword.type">
            {{ invalidPassword.msg }}
          </div>
        </div>
      </b-col>
    ...
    <b-row class="my-1">
      <b-col md="4" lg="3">
        <div class="form-group">
          ...
          <div class="invalid" v-show="invalidConfirm.type">
            {{ invalidConfirm.msg }}
          </div>
        </div>
      </b-col>
    ...
    <div class="form-group">
      <button id="save" class="btn btn-primary" @click="onReset">
        Register
      </button>
    </div>
  </b-container>
  ...
  methods: {
    onReset() {
      ...
      user.auth(subData).then((response) => {
        ...
        if (code == 0 || code == '0') {
          MessageBox.alert(
            'The registration succeeds and the login page is displayed',
            'prompt',
            {
