<template>
  <b-container class="mt">
    <div class="container page my-5 p-5" style="">
      ...
      Please fill out the form below to change your account settings or your
      password.
      <br />
      <br />
      ...
      <div class="form-group">
        <label for="firstName" class="control-label"
          >First Name:<img class="asterisk" :src="imgUrls.asterisk"
        /></label>
        <input
          id="firstName"
          name="firstName"
      ...
      <div class="form-group">
        <label for="lastName" class="control-label"
          >Last Name:<img class="asterisk" :src="imgUrls.asterisk"
        /></label>
        <input
          id="lastName"
          name="lastName"
      ...
      <div class="form-group">
        <label for="email" class="control-label"
          >E-Mail:<img class="asterisk" :src="imgUrls.asterisk"
        /></label>
        <input
          id="email"
          name="email"
      ...
      <div class="form-group">
        <label for="jobTitle" class="control-label"
          >Job Title:<img class="asterisk" :src="imgUrls.asterisk"
        /></label>
        <input
          id="jobTitle"
          name="jobTitle"
      ...
      <div class="form-group">
        <label for="organisation" class="control-label"
          >Organisation:<img class="asterisk" :src="imgUrls.asterisk"
        /></label>
        <input
          id="organisation"
          name="organisation"
      ...
      <div class="form-group">
        <label for="country" class="control-label"
          >Country:<img class="asterisk" :src="imgUrls.asterisk"
        /></label>
        <input
          id="country"
          name="country"
      ...
      <div class="form-group">
        <label for="city" class="control-label"
          >City:<img class="asterisk" :src="imgUrls.asterisk"
        /></label>
        <input
          id="city"
          name="city"
      ...
      <div class="control-group">
        <div class="controls">
          <button class="btn btn-danger" id="delete_account">
            Delete Account
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    update() {
      this.msgBox = ''
      this.$bvModal
        .msgBoxConfirm('Are you sure to modify it?', {
