<template>
  <div
    class="rounded border-2 border-dashed border-primary-hover position-relative mb-6"
  >
    <uploader
      ref="uploader"
      :options="options"
  ...
  methods: {
    onFileAdded(file) {
      ...
      if (!isEmpty(this.fileName)) {
        fileName1 =
          this.fileName +
          fileName1.substring(fileName1.indexOf('.'), fileName1.length)
        file.name = fileName1
      }
